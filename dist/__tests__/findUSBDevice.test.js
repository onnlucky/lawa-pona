...
test("parses osx ioreg", () => {
    expect(() => findUsbDevice_1.osxOutputParser("xxx")).toThrow();
    expect(findUsbDevice_1.osxOutputParser(osxOutput)).toBe("/dev/tty.usbmodem144101");
});
test("parses linux ls -l /dev/serial/by-id", () => {
    expect(() => findUsbDevice_1.linuxOutputParser("xxx")).toThrow();
    expect(findUsbDevice_1.linuxOutputParser(linuxOutput)).toBe("/dev/ttyACM0");
});
//# sourceMappingURL=findUSBDevice.test.js.map